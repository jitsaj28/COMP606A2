...
?>
        ...
        <script type="text/javascript">
            ...
            function SaveDetails(){
               ...
               window.location.href="AddTrademan_prc.php?txtName="+txtName+"&txtAddress="+txtAddress+"&txtemail="+txtemail+"&txtmobileno="+txtmobileno+"&txtuname="+txtuname+"&txtupass="+txtupass  + "";
                }
